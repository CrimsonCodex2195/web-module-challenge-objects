...
createMenuItem('French Fries', 1, 'Snack');
createMenuItem('BLT Sandwich', 3, 'Breakfast');
createMenuItem('Spaghetti and Meatballs', 5, 'Dinner');
...
reviews.push({
  name: 'Shariq',
  review: 4,
  feedback: "FOOD FOOD FOOD THIS PLACE SO TASTY"
});
console.log(reviews);
